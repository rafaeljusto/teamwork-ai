...
// Creation represents the payload for creating a new milestone in Teamwork.com.
//
...
func (c Creation) HTTPRequest(ctx context.Context, server string) (*http.Request, error) {
	...
	paylaod := struct {
		Milestone Creation `json:"milestone"`
	}{Milestone: c}
...
type Update struct {
	...
	Description *string        `json:"description,omitempty"`
	DueDate     *teamwork.Date `json:"deadline,omitempty"`
