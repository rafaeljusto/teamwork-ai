...
func TestResources_companies(t *testing.T) {
	...
	request.Params.URI = "twapi://companies"
...
func TestResources_company(t *testing.T) {
	mcpServer := server.NewMCPServer("test-server", "1.0.0")
	company.Register(mcpServer, &config.Resources{
		TeamworkEngine: engineMock{},
	})
	...
	request.Params.URI = "twapi://companies/123"
