	...
	mcpServer.AddTool(
		mcp.NewTool("retrieve-activities",
			...
			mcp.WithString("start-date",
				mcp.Description("Start date to filter activities. The date format folows RFC3339 - YYYY-MM-DDTHH:MM:SSZ."),
			),
			mcp.WithString("end-date",
				mcp.Description("End date to filter activities. The date format folows RFC3339 - YYYY-MM-DDTHH:MM:SSZ."),
			),
	...
	mcpServer.AddTool(
		mcp.NewTool("retrieve-project-activities",
			...
			mcp.WithNumber("project-id",
				mcp.Required(),
				mcp.Description("The ID of the task to retrieve activities from."),
			),
			mcp.WithString("start-date",
				mcp.Description("Start date to filter activities. The date format folows RFC3339 - YYYY-MM-DDTHH:MM:SSZ."),
			),
