...
func TestResources_tasklists(t *testing.T) {
	...
	request.Params.URI = "twapi://tasklists"
...
func TestResources_tasklist(t *testing.T) {
	mcpServer := server.NewMCPServer("test-server", "1.0.0")
	tasklist.Register(mcpServer, &config.Resources{
		TeamworkEngine: engineMock{},
	})
	...
	request.Params.URI = "twapi://tasklists/123"
