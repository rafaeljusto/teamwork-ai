...
func TestResources_milestones(t *testing.T) {
	...
	request.Params.URI = "twapi://milestones"
...
func TestResources_milestone(t *testing.T) {
	mcpServer := server.NewMCPServer("test-server", "1.0.0")
	milestone.Register(mcpServer, &config.Resources{
		TeamworkEngine: engineMock{},
	})
	...
	request.Params.URI = "twapi://milestones/123"
